...
require (
	...
	github.com/go-kratos/kratos/contrib/config/apollo/v2 v2.0.0-20230509063647-4a56b5669def
	github.com/go-kratos/kratos/contrib/registry/eureka/v2 v2.0.0-20230509063647-4a56b5669def
